...
export function LibraryPage() {
  ...
  const st: Record<string, React.CSSProperties> = {
    ...
    title: { fontSize: 22, fontWeight: 600, color: 'var(--text-primary)' },
    ...
    uploadBtn: { display: 'flex', alignItems: 'center', gap: 6, padding: '9px 18px', background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontSize: 13, fontWeight: 500 },
    ...
    detailPanel: { position: 'fixed', top: 0, right: 0, width: 500, height: '100vh', background: 'var(--bg-base)', borderLeft: '1px solid var(--border-subtle)', padding: 24, overflow: 'auto', zIndex: 100 },
