...
const API_KEYS: ApiKeyConfig[] = [
  ...
  { key: 'aws_access_key', label: 'AWS Access Key', placeholder: 'AKIA...', hint: 'Amazon Polly TTS voices (neural)' },
...
const S: Record<string, React.CSSProperties> = {
  ...
  backBtn: {
    ...
    border: 'none', color: 'var(--accent)', cursor: 'pointer', padding: 0, fontSize: 12, fontWeight: 500,
    marginBottom: -16,
  },
  title: { fontSize: 22, color: 'var(--text-primary)', fontWeight: 700, letterSpacing: '-0.5px' },
  subtitle: { fontSize: 12, color: 'var(--text-tertiary)', lineHeight: 1.6, marginTop: 4 },
  section: { display: 'flex', flexDirection: 'column', gap: 12 },
  sectionTitle: { fontSize: 14, color: 'var(--accent)', fontWeight: 600 },
  sectionHint: { fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.5 },
  keyRow: {
    padding: 18, background: 'var(--bg-surface)', borderRadius: 'var(--radius-lg)',
    border: '1px solid var(--border-subtle)', display: 'flex', flexDirection: 'column', gap: 8,
  },
  keyHeader: { display: 'flex', alignItems: 'center', gap: 8 },
  keyLabel: { fontSize: 13, color: 'var(--text-primary)', fontWeight: 600 },
  storedBadge: {
    display: 'flex', alignItems: 'center', gap: 4, fontSize: 10,
    color: 'var(--success)', background: 'var(--success-subtle)', padding: '3px 10px', borderRadius: 20, fontWeight: 500,
  },
  keyHint: { fontSize: 11, color: 'var(--text-muted)' },
  ...
  input: {
    ...
    border: '1px solid var(--border-default)', background: 'var(--bg-deep)', color: 'var(--text-primary)',
  ...
  deleteBtn: {
    background: 'none', border: '1px solid rgba(248,113,113,0.15)', color: 'var(--danger)',
    borderRadius: 8, cursor: 'pointer', padding: '7px 9px', display: 'flex',
  },
  select: {
    padding: '10px 14px', borderRadius: 10, border: '1px solid var(--border-default)',
    background: 'var(--bg-deep)', color: 'var(--text-primary)', fontSize: 13, outline: 'none', maxWidth: 320,
  },
};
